...
- Use WHERE to get a subset of cars whose brand is 'Honda'
...
- From cars, obtain the average of price by brand using GROUP BY
- Use ORDER BY to sort by the average of price in descending order
- Limit the results to the top 3 brands with the highest average price
...
- Use HAVING to filter brands with an average mpg strictly higher than 25
...
- From cars, obtain the average, min, and max of each brand's trunk space using GROUP BY
...
- Select the columns make, mpg, displacement, and origin_type
